...
const NavBar: FC = () => {
  ...
  return <nav className="grid max-md:grid-cols-5 md:flex md:flex-col bg-tuatara-50 dark:bg-tuatara-900 max-md:w-full md:h-screen p-1 md:p-2 md:min-w-56 shadow-modal shadow-tuatara-950">
