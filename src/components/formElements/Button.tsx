  ...
  return (
    <button {...props}
      className={classNames(
        ...
        "border-1 border border-current":
          variant !== "text",
        "hover:ring-2 focus:ring-2 active:ring-1 ring-current w-full":
          variant !== "text",
        "hover:underline":
          variant === "text",
        "bg-opacity-0":
        ...
        "cursor-not-allowed opacity-50":
          props.disabled,
        "bg-creamcan-500 dark:text-creamcan-50 text-creamcan-950":
          variant === "default" && color === "primary",
        "bg-leaf-500 dark:text-leaf-50 text-leaf-950":
          variant === "default" && color === "secondary",
        "bg-rose-500 dark:text-rose-50 text-rose-950":
          variant === "default" && color === "danger",
        "bg-emerald-500 dark:text-emerald-50 text-emerald-950":
          variant === "default" && color === "success",
        "bg-orange-500 dark:text-orange-50 text-orange-950":
          variant === "default" && color === "warning",
        "bg-cyan-500 dark:text-cyan-50 text-cyan-950":
          variant === "default" && color === "info",
        "bg-tuatara-950 text-tuatara-50":
          variant === "default" && color === "dark",
        "bg-white dark:text-tuatara-50 text-tuatara-950":
          variant === "default" && color === "light",
        "bg-transparent text-creamcan-500":
          color === "primary" && variant !== "default",
        "bg-transparent text-leaf-500":
        ...
        "bg-transparent text-tuatara-950":
          color === "dark" && variant !== "default",
        "bg-transparent text-tuatara-50":
          color === "light" && variant !== "default",
