...
const WinConstantPairs: FC = () => {
  return <Window compact>
    ...
    <fieldset className="leading-normal text-sm border border-leaf-600 dark:border-leaf-400 bg-gradient-to-tl dark:from-leaf-900 dark:to-leaf-700 border-opacity-20 from-leaf-300 to-leaf-100 dark:border-opacity-20 rounded p-4 grid gap-2 my-2">
      <p>
